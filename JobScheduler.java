...
public class JobScheduler {
	 ...
	 */
	public static int[] completionTime(int scheduler[][],int numOfProcesses)
	{
	 ...
	 */
	public static int[] waitingTime(int scheduler[][],int numOfProcesses)
	{
		int waitingTime[]=new int[numOfProcesses];
		waitingTime[0]=0;
		int completionTime[]=completionTime(scheduler,numOfProcesses);
		for(int i=1;i<numOfProcesses;i++)
		{
	 ...
	 */
	public static int[] turnAroundTime(int scheduler[][],int numOfProcesses)
	{
		int turnAroundTime[]=new int[numOfProcesses];
		int waitingTime[]=waitingTime(scheduler,numOfProcesses);
	 ...
	 */
	public static double avgWaitingTime(int scheduler[][],int numOfProcesses)
	{
		int waitingTime[]=waitingTime(scheduler,numOfProcesses);
	...
	public static void main(String[] args) {
		...
		{
		case 1:
			int[] completionTimeResult=completionTime(scheduler,numOfProcesses);
			System.out.println("Process    Completion Time");
			printlist(completionTimeResult);
			break;
		case 2:
			
			int[] waitingTimeResult=waitingTime(scheduler,numOfProcesses);
			System.out.println("Process   Waiting Time");
			printlist(waitingTimeResult);
			break;
		case 3:
			int[] turnAroundTimeResult=turnAroundTime(scheduler,numOfProcesses);
			System.out.println("Process   TurnAround Time");
			printlist(turnAroundTimeResult);
			break;
		case 4:
			double averageWaitingTime=avgWaitingTime(scheduler,numOfProcesses);
